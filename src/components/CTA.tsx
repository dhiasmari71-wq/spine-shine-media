...
const CTA = () => {
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="w-full max-w-[347px] md:max-w-[577px] flex flex-col items-center mt-[324px] md:mt-[190px] mb-[100px]">
        <div className="w-full max-w-[577px] min-h-[412px] rounded-[20px] bg-[linear-gradient(135.37deg,rgba(255,215,0,0.27)_0%,rgba(255,215,0,0.04)_100%)] border-4 border-border pt-6 px-10 pb-[70px]">
          <h1 className="text-primary font-poppins font-bold text-[35px] md:text-[49px] mb-4 bg-transparent">
